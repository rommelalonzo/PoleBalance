/*
* $XConsortium: ButtonI.h,v 1.16 89/05/11 01:05:05 kit Exp $
*/
...
/*
 *
 *  A few definitions to make Button.c easier to read.
 *   
 */
...
#define ComWhighlightThickness           cbw->button.highlight_thickness
#define ComWset                          cbw->button.set
#define ComWhighlighted                  cbw->button.highlighted

#define XtCBField(cbw,field)  cbw->button.field
